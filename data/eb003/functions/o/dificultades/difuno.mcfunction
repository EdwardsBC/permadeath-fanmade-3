...
scoreboard players set @e[tag=pdscored] failProbability 3
...
execute at @e[tag=,limit=1,sort=nearest,type=minecraft:phantom] run function eb003:mobs/2
tag @e[tag=,limit=1,sort=nearest,type=minecraft:phantom] add found

execute as @e[type=minecraft:player] if entity @e[type=minecraft:phantom,distance=..20] run effect give @p minecraft:blindness 3 0
...
execute at @e[tag=,limit=1,sort=nearest,type=ghast] run function eb003:mobs/7
